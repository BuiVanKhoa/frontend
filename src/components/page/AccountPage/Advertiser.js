...
class Advertiser extends React.Component {
  ...
  componentDidMount(){ //khi component dc load thi su kien se dong thoi xay ra
        this.props.fetchListAdvertiserAccount();
      
  }

  render() {
    const listAdvertiser= this.props.listAdvertiserAccount
    return (
      <>
                ...
                <div className="modal-dialog">
                  <div className="modal-content">
                    ...
                    <div className="modal-body">
                      <FormCreateDacAccount callform="formCreateAdvertiser"/>
                    </div>
                    {/* Modal footer */}
        ...
        <div className="list_acc">
          <table className="table">
            ...
            <tbody>
              <Table col="7" dt={listAdvertiser} accountType="advertiser"></Table>
            </tbody>
          </table>
        </div>
      </>
...
const mapStateToProps =(state)=>{ //lay state trog store
  return {
    listAdvertiserAccount: state.crudAdvertiser
  }
}
const mapDispatchToProps =(dispatch)=>{ // gui action tuong ung vs su kien
  return{
    fetchListAdvertiserAccount: () =>dispatch(accountAction.fetchListAdvertiserAccount())
  }
}
